      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4 dark:text-gray-200">How to Work </h2>
            <p className="text-xl text-gray-600">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quae temporibus nihil ab cum quos numquam, facilis doloremque error ad earum magni laboriosam suscipit eos aliquid, neque eum ullam ipsam illo.</p>
          </div>
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl dark:bg-gray-800">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1 dark:text-gray-200">Initial Contact</h4>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl dark:bg-gray-800">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1 dark:text-gray-200">Discovery Session</h4>
              <p className="text-gray-600 text-center">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl dark:bg-gray-800">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1 dark:text-gray-200">Contracting</h4>
              <p className="text-gray-600 text-center">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl dark:bg-gray-800">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1 dark:text-gray-200">Fast Prototyping</h4>
              <p className="text-gray-600 text-center">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl dark:bg-gray-800">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1 dark:text-gray-200">Design Phase</h4>
              <p className="text-gray-600 text-center">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl dark:bg-gray-800">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1 dark:text-gray-200">Develop & Launch</h4>
              <p className="text-gray-600 text-center">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
            </div>
