      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12 border-t border-gray-200">
          ...
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-2">
            <h6 className="text-gray-800 font-medium mb-2 dark:text-gray-300 ">Products</h6>
            <ul className="text-sm">
              <li className="mb-2 dark:text-gray-500 ">
          ...
          {/* 3rd block */}
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-2">
            <h6 className="text-gray-800 font-medium mb-2 dark:text-gray-300 ">Resources</h6>
            <ul className="text-sm">
              <li className="mb-2 dark:text-gray-500 ">
          ...
          {/* 4th block */}
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-2">
            <h6 className="text-gray-800 font-medium mb-2 dark:text-gray-300 ">Company</h6>
            <ul className="text-sm">
              <li className="mb-2 dark:text-gray-500 ">
          ...
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-3">
            <h6 className="text-gray-800 font-medium mb-2 dark:text-gray-300 ">Subscribe</h6>
              ...
              <div className="flex flex-wrap mb-4">
                <div className="w-full">
                  ...
                  <div className="relative flex items-center max-w-xs">
                    <input id="newsletter" type="email" className="form-input w-full bg-gray-100 rounded text-gray-800 px-3 py-2 pr-12 text-sm" placeholder="Your email" required />
        ...
        <div className="md:flex md:items-center md:justify-between py-4 md:py-8 border-t border-gray-200">
          ...
          {/* Copyrights note */}
          <div className="text-sm text-gray-600 mr-4">Made by <a className="text-blue-600 hover:underline" href="#">Source</a>. All rights reserved.</div>
