...
const CreateNewService: NextPage<CreateServiceProps> = ({}) => {
  ...
  const { mutate: CreateService, isLoading } = useCreateServiceMutation<Error>(
    graphqlRequestClient,
    {
      onSuccess(data: CreateServiceMutation) {
...
if(trolley==="trolley1"){
  ...
  const onSubmitHandler: SubmitHandler<ServiceInput> = async (values) => {
    CreateService({
          ...
          <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md  lg:max-w-4xl xl:p-0 dark:bg-gray-800 dark:border-gray-700">
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <FormProvider {...methods}>
                ...
                >
                  <FormInput label="Service Name" name="serviceName" />
