import { createForOfIteratorHelperLoose as _createForOfIteratorHelperLoose } from '../_virtual/_rollupPluginBabelHelpers.mjs';
...
function splitModifiers(className) {
  ...
  for (var _iterator = _createForOfIteratorHelperLoose(className.matchAll(/[:[\]]/g)), _step; !(_step = _iterator()).done;) {
